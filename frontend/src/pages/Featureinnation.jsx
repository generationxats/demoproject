...
const Featureinnation = () => {
  ...
  return (
    ...
    <p className='flex items-center gap-1 justify-center py-4'><span className='text-yellow-600'><MdVerified/></span>Feature your add on top position in across nation .</p>
...
export default Featureinnation